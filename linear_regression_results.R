...
energy.income.mod <- lm(energy~metro + income,data = na.omit(states.data))

plot(energy.income.mod)
#compare
anova(energy.mod,energy.income.mod)
coef(summary(energy.income.mod))
...
energy.metro.by.expense <- lm(energy~metro*expense, data = states.data)
coef(summary(energy.metro.by.expense))
